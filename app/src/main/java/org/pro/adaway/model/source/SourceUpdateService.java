...
public final class SourceUpdateService {
    ...
    public static class HostsSourcesUpdateWorker extends Worker {
        ...
        public Result doWork() {
            if (BuildConfig.DEBUG) Log.i("AWAISKING_APP", "Starting update worker");
            // Create model
            ...
            try {
                ...
                if (BuildConfig.DEBUG)
                    Log.e("AWAISKING_APP", "Failed to check for update. Will retry later.", exception);
                return retry();
            }
            if (hasUpdate) {
                // Do update
                try {
                    ...
                    if (BuildConfig.DEBUG)
                        Log.e("AWAISKING_APP", "Failed to apply hosts file during background update.", exception);
                    return failure();
                }
            }
            // Return as success
